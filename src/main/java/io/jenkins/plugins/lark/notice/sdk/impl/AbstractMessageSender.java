...
public abstract class AbstractMessageSender implements MessageSender {
     ...
     */
    protected abstract RobotConfigModel getRobotConfiguration();
    ...
    protected SendResult sendMessage(String jsonBody, String... headers) {
        RobotConfigModel robotConfig = getRobotConfiguration();
        ...
        try {
            ...
            HttpClient httpClient = HttpClientFactory.buildHttpClient(robotConfig.getProxySelector());
